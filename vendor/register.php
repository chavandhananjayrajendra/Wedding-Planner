                ...
                <div class="card card-outline card-primary col-12 rounded-0 shadow">
                    ...
                    <form id="vregister-frm" action="" method="post">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-6">
                                <label for="shop_owner" class="control-label">Vendor Fullname</label>
                            ...
                            <div class="form-group col-md-6">
                                <label for="shop_type_id" class="control-label">Vendor Type</label>
                        ...
                        <div class="row">
                            <div class="form-group col-md-6">
                                <label for="logo" class="control-label">Vendor Logo</label>
