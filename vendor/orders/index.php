                            ...
                            <?php 
                                switch($row['status']){
                                    case 0:
                                        ...
                                        break;
                                    case 1:
                                        echo '<span class="badge badge-primary bg-gradient-primary px-3 rounded-pill">Booking Confirmed</span>';
                                        break;
                                    case 2:
                                        echo '<span class="badge badge-info bg-gradient-info px-3 rounded-pill">Cancelled(Slot full)</span>';
                                        break;
